(() => {
    document.addEventListener("DOMContentLoaded", () => {
        let i = document.getElementById("desktop-search-input"), o = document.getElementById("mobile-search-input"), n = document.getElementById("mobile-search-icon"), t = document.getElementById("mobile-search-container"), c = `
